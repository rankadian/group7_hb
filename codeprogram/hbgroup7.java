...
public class hbgroup7 {
    ...
    double DiscountPromo = 10; 
    double DiscountCashBack = 5;
    double DiscountPayment = 8;
    double DiscountHolidaySeason = 6;
    double DiscountMemberHotel = 7;

    System.out.print("Enter The Number Of Nights Stayed: ");
    int nights = dexterHotel.nextInt();
    
    System.out.print("Enter The Price Per Night: ");
    double pricePerNight = dexterHotel.nextDouble();

    System.out.print("Enter typeRoom (Standard, Superior, Deluxe, Single, Twin, Double, Family, Junior Suite, Suite, Presidential Suite, Connecting, Disabled, Smoking): ");
    String typeRoom = dexterHotel.next();

    //total cost before discount
    double totalBeforeDiscount = nights * pricePerNight;
    double discountPercentage = 0.00; //determine the discount based on the type of room we want(menentukan diskon berdasarkan jenis kamar yang kita inginkan)
    ...
    if (typeRoom.equals("Standard")) {
        ...
        discountPercentage = 0.00;
    } else if (typeRoom.equals("Single")) {
        discountPercentage = 0.00;
    } else if (typeRoom.equals("Twin")) {
        discountPercentage = 0.00;
    } else if (typeRoom.equals("Double")) {
        discountPercentage = 0.00;
    } else if (typeRoom.equals("Family")) {
        discountPercentage = 0.00;
    } else if (typeRoom.equals("Junior Suite")) {
        discountPercentage = 0.00;
    } else if (typeRoom.equals("Suite")) {
        discountPercentage = 0.00;
    } else if (typeRoom.equals("Presidential Suite")) {
        discountPercentage = 0.00;
    } else if (typeRoom.equals("Connecting")) {
        discountPercentage = 0.00;
    } else if (typeRoom.equals("Disabled")) {
        discountPercentage = 0.00;
    } else if (typeRoom.equals("Smoking")) {
        discountPercentage = 0.00;    
        }

        double totalAllDiscount = totalBeforeDiscount * discountPercentage; 
        double totalPAymentAfterDiscount = totalBeforeDiscount - totalAllDiscount;

        System.out.println("Total Cost Before Discount: $" + totalBeforeDiscount);
        System.out.println("Discount To Type Room " + typeRoom + ": $" + totalAllDiscount);
        System.out.println("Total Payment After Discount; $" + totalPAymentAfterDiscount);
