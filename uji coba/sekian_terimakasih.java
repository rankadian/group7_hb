...
public class sekian_terimakasih {
    ...
    public static void main(String[] args) {
        ...
        // price of additional facilities
        double extraMatrres = 100000.00;
        double extraPillow = 25000.00;
        double specialEvent = 75000.00;
        double babyCot = 30000.00;
        double breakfast = 60000.00;

        // price of type room
        double priceStandard = 350000.00;
        double priceSuperior = 450000.00;
        double priceDeluxe = 600000.00;
        double priceSingle = 375000.00;
        double priceTwin = 500000.00;
        double priceDouble = 550000.00;
        double priceFamily = 750000.00;
        double priceJunior = 1250000.00;
        double priceSuite = 1700000.00;
        double pricePresidential = 3000000.00;
        double priceConnected = 650000.00;
        double priceDisabled = 600000.00;
        double priceSmoking = 400000.00;
        ...
        int taxBRI = 25000;
        int taxBCA = 30000;
        int taxMandiri = 45000;
        int taxBNI = 15000;

        // disc payment
        double discBRI = 15.0;
        double discBCA = 12.0;
        double discMandiri = 17.0;
        double discBNI = 10.0;
        double discCash = 20.0;

        // final total payment
        double totalFinalBRI = 0.00;
        double totalFinalBCA = 0.00;
        double totalFinalMadiri = 0.00;
        double totalFinalBNI = 0.00;
        double totalFinalCash = 0.00;
        ...
        while (true) {
            ...
            System.out.println("6. Give riview");
            ...
            switch (menuChoice) {
                ...
                case 3: // select type room and number of room
                    ...
                    switch (chooseTypeRoom) {
                        ...
                        case 10:
                            ...
                            totalroom = stay * pricePresidential;
                ...
                case 4: // add additional facilities
                    ...
                    switch (chooseFacilities) {
                        case 1:
                            totaladdfac = order * extraMatrres;
                            namaadd = "Extra Mattress";
                            System.out.println(namaadd + " of additions -" + order + " Price is Rp " + totaladdfac);
                            break;

                        case 2:
                            totaladdfac = order * extraPillow;
                            namaadd = "Extra Pillow";
                            System.out.println(namaadd + " of additions -" + order + " Price is Rp " + totaladdfac);
                            break;

                        case 3:
                            totaladdfac = order * specialEvent;
                            namaadd = "Special Even";
                            System.out.println(namaadd + " of additions -" + order + " Price is Rp " + totaladdfac);
                            break;

                        case 4:
                            totaladdfac = order * babyCot;
                            namaadd = "Baby Coat";
                            System.out.println(namaadd + " of additions -" + order + " Price is Rp " + totaladdfac);
                            break;

                        case 5:
                            totaladdfac = order * breakfast;
                ...
                case 5: // payment methods
                    ...
                    System.out.println("1. BRI                  Rp 25.000");
                    System.out.println("2. BCA                  Rp 30.000");
                    System.out.println("3. MANDIRI              Rp 45.000");
                    System.out.println("4. BNI                  Rp 15.000");
                    ...
                    switch (choosepayment) {
                        case 1:
                            ...
                            System.out.println("================================================");
                            double totalDiscBRI = total * discBRI / 100;
                            double totalBRI = total - totalDiscBRI;
                            totalFinalBRI = totalBRI + taxBRI;
                            System.out.println("The Total Price Is                   : Rp " + totalFinalBRI);
                            break;
                        case 2:
                            System.out.println("                    RECEIPT                     ");
                            System.out.println("================================================");
                            ...
                            System.out.println("================================================");
                            double totalDiscBCA = total * discBCA / 100;
                            double totalBCA = total - totalDiscBCA;
                            totalFinalBCA = totalBCA + taxBCA;
                            System.out.println("The Total Price Is                 : Rp " + totalFinalBCA);
                            break;
                        case 3:
                            System.out.println("                    RECEIPT                     ");
                            System.out.println("================================================");
                            ...
                            System.out.println("================================================");
                            double totalDiscMandiri = total * discMandiri / 100;
                            double totalMandiri = total - totalDiscMandiri;
                            totalFinalMadiri = totalMandiri + taxMandiri;
                            System.out.println("The Total Price Is                   : Rp " + totalFinalMadiri);
                            break;
                        case 4:
                            System.out.println("                    RECEIPT                     ");
                            System.out.println("================================================");
                            ...
                            System.out.println("================================================");
                            double totalDiscBNI = total * discBNI / 100;
                            double totalBNI = total - totalDiscBNI;
                            totalFinalBNI = totalBNI + taxBNI;
                            System.out.println("The Total Price Is                   : Rp " + totalFinalBNI);
                            break;
                        case 5:
                            System.out.println("                    RECEIPT                     ");
                            System.out.println("================================================");
                            ...
                            System.out.println("================================================");
                            double totalDiscCash = total * discCash / 100;
                            totalFinalCash = total - totalDiscCash;
                            System.out.println("The Total Price Is                   : Rp " + totalFinalCash);
                        default:
                            break;
                    }
                    System.out.println("================================================");
                ...
                case 7: // exit and print invoice booking
                    System.out.println("================================================");
                    System.out.println("                 !!!THANK YOU!!!                ");
                    ...
                    switch (choosepayment) {
                        case 1:
                            System.out.println("Total payment            : " + totalFinalBRI);
                            break;
                        
                        case 2:
                            System.out.println("Total payment            : " + totalFinalBCA);
                            break;

                        case 3:
                            System.out.println("Total payment            : " + totalFinalMadiri);
                            break;

                        case 4:
                            System.out.println("Total payment            : " + totalFinalBNI);
                            break;

                        case 5:
                            System.out.println("Total payment            : " + totalFinalCash);
                            break;
            ...
            System.out.print("Would you like to return to the main menu to continue the reservation process? (y/n) : "); // to looping again back to menu
            next = sc.next();
            System.out.println("================================================");
