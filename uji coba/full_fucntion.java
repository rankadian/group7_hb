...
public class full_fucntion {
    ...
    static int age = 0;
    static String gmail = "";
    static String numTelephone = "";
    static int people = 0;
    static String checkIn = "";

    // info room
    static int menuTypeRoom;

    // select type room
    static int chooseTypeRoom = 0;
    static int stay = 0;
    static int totalroom = 0;
    static String nameRoom = null;

    // number of room
    static String[] standard = { "200", "201", "202", "203", "204", "205", "206", "207", "208", "209", "210" };
    static boolean isStandard = false;

    static String[] superior = { "300", "301", "302", "303", "304", "305", "306", "307", "308", "309", "310" };
    static boolean isSuperior = false;

    static String[] deluxe = { "400", "401", "402", "403", "404", "405", "406", "407", "408", "409", "410" };
    static boolean isDeluxe = false;

    static String[] single = { "211", "212", "213", "214", "215", "216", "217", "218", "219", "220" };
    static boolean isSingle = false;

    static String[] twin = { "311", "312", "313", "314", "315", "316", "317", "318", "319", "320" };
    static boolean isTwin = false;

    static String[] doubled = { "411", "412", "413", "414", "415", "416", "417", "418", "419", "420" };
    static boolean isDoubled = false;

    static String[] family = { "500", "501", "502", "503", "504", "505", "506", "507", "508", "509", "510" };
    static boolean isFamily = false;

    static String[] junior = { "511", "512", "513", "514", "515" };
    static boolean isJunior = false;

    static String[] suite = { "601", "602", "603", "604", "605" };
    static boolean isSuite = false;

    static String[] presidential = { "701", "702", "703" };
    static boolean isPresidential = false;

    static String[] connecting = { "221", "222", "223", "224", "225", "321", "322", "323", "324", "325" };
    static boolean isConnecting = false;

    static String[] disabled = { "421", "422", "423", "424", "425", "426", "427", "428", "429", "430" };
    static boolean isDisabled = false;

    static String[] smoking = { "226", "227", "228", "229", "230", "326", "327", "328", "329", "330" };
    static boolean isSmoking = false;

    // select add facilities
    static int order = 0;
    static int totaladdfac = 0;
    static int chooseFacilities = 0;
    static String namaadd = null;
    ...
    public static void inputPersonalData(Scanner sc) {
    ...
    public static void infoRoom(Scanner sc) {
    ...
    public static void facilities(Scanner sc) {
    ...
    public static void payment() {
        int total = totalroom + totaladdfac;
