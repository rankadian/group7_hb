...
public class cobaepan {
    ...
    public static void main(String[] args) {
        ...
        // for the price room in rupiah IDR
        int price_standard = 350000;
        int price_superior = 450000;
        int price_deluxe = 600000;
        int price_single = 375000;
        int price_twin = 500000;
        int price_doubled = 550000;
        int price_family = 750000;
        int price_junior = 1250000;
        int price_suite = 1700000;
        int price_presidential = 3000000;
        int price_connected = 650000;
        int price_disabled = 600000;
        int price_smoking = 400000;

        // for the price add facilities
        int extra_mattess = 50000;
        int extra_pillow = 10000;
        int special_event = 50000;              //harga sementara
        int baby_coat = 30000;
        int food_or_beveragepackges = 50000;
        ...
        while (true) {
            ...
            System.out.println("5. Calculation of room prices");
            System.out.println("6. Calculation off additional facilities");
            System.out.println("7. Payment Methods");
            System.out.println("8. Exit");
            System.out.println("");

            System.out.print("Choice a menu (1/2/3/4/5/6) : ");
            ...
            switch (menuChoice) {
                ...
                case 4:
                    ...
                    System.out.println("1. Extra mattress price is 50000");
                    System.out.println("2. Extra pillow price is 10000");
                    System.out.println("3. Special event price is 50000");
                    System.out.println("4. Baby cot is 30000");
                    System.out.println("5. Food or Beverage Packages price is 50000");
                    ...
                    System.out.println("================================================");
                    System.out.print("How many additional facilities : ");
                    addfac = sc.nextInt();
                break;
                ...
                case 5:
                    ...
                    System.out.print("Select a room to continue paying for the room : ");
                    paymentRoom = sc.nextInt();
                    System.out.println("================================================");

                    switch (paymentRoom) {
                        case 1: 
                            System.out.println("Standard room price");
                            System.out.println("The price is " +price_standard * stay);
                            totalroom += price_standard * stay;
                            break;
                        case 2:
                            System.out.println("Superior room price");
                            System.out.println("The price is " +price_superior * stay);
                            totalroom += price_superior * stay;
                            break;
                        case 3:
                            System.out.println("Duluxe room price");
                            System.out.println("The price is " +price_deluxe * stay);
                            totalroom += price_deluxe + stay;
                            break;
                        case 4: 
                            System.out.println("Single room price");
                            System.out.println("The price is " +price_single * stay);
                            totalroom += price_single + stay;
                            break;
                        case 5:
                            System.out.println("Twin room price");
                            System.out.println("The price is " +price_twin * stay);
                            totalroom += price_twin + stay;
                            break;
                        case 6:
                            System.out.println("Doubled room price");
                            System.out.println("The price is " +price_doubled * stay);
                            totalroom += price_doubled + stay;
                            break;
                        case 7:
                            System.out.println("Family room price");
                            System.out.println("The price is " +price_family * stay);
                            totalroom += price_family + stay;
                            break;
                        case 8:
                            System.out.println("Junior room price");
                            System.out.println("The price is " +price_junior * stay);
                            totalroom += price_junior + stay;
                            break;
                        case 9:
                            System.out.println("Suite room price");
                            System.out.println("The price is " +price_suite * stay);
                            totalroom += price_suite + stay;
                            break;
                        case 10:
                            System.out.println("Presidential room price");
                            System.out.println("The price is " +price_presidential * stay);
                            totalroom += price_presidential + stay;
                            break;
                        case 11:
                            System.out.println("Connected room price");
                            System.out.println("The price is " +price_connected * stay);
                            totalroom += price_connected + stay;
                            break;
                        case 12:
                            System.out.println("Disabled room price");
                            System.out.println("The price is " +price_disabled * stay);
                            totalroom += price_disabled + stay;
                            break;
                        case 13:
                            System.out.println("Smoking room price");
                            System.out.println("The price is " +price_smoking * stay);
                            totalroom += price_smoking + stay;
                            break;
                    }
                        break;
                case 6:
                    ...
                    System.out.print("Refill additional facilities: ");
                    chooseFac = sc.nextInt();
                    System.out.println("================================================");
                    switch (chooseFac) {
                        case 1:
                            System.out.println("Extra mattress");
                            reservationDetails += "Extra mattress\nThe price is " + extra_mattess * addfac + "\n";
                            totalReservationPrice += extra_mattess * addfac;
                            break;
                        case 2:
                            System.out.println("Extra pillow");
                            reservationDetails += "Extra pillow\nThe price is " + extra_pillow * addfac + "\n";
                            totalReservationPrice += extra_pillow * addfac;
                            break;
                        case 3:
                            System.out.println("Special event");
                            reservationDetails += "Special event\nThe price is " + special_event * addfac + "\n";
                            totalReservationPrice += special_event * addfac;
                            break;
                        case 4:
                            System.out.println("Baby cot");
                            reservationDetails += "Baby cot\nThe price is " + baby_coat * addfac + "\n";
                            totalReservationPrice += baby_coat * addfac;
                            break;
                        case 5:
                            System.out.println("Food or Beverage Packages price");
                            reservationDetails += "Food or Beverage Packages price\nThe price is " + food_or_beveragepackges * addfac + "\n";
                            totalReservationPrice += food_or_beveragepackges * addfac;
                            break;
                    }
                    break;
            
                        case 7:
                            // Memeriksa apakah fasilitas sudah dipilih sebelumnya
                            if (!reservationDetails.isEmpty()) {
                                System.out.println("Reservation details:");
                                System.out.println("Add fac " + reservationDetails);
                                System.out.println("Chooice room " + totalroom);

                                totalprice = totalReservationPrice + totalroom;
                                System.out.println("Total Reservation Price: " + totalprice);
                            } else {
                                System.out.println("Please choose a facility first!"); 
